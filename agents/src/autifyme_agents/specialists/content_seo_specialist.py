...
from autifyme_agents.schemas.specialist_outputs.content_seo import (
    ContentSEODraft,  # noqa: F401
    PlatformContentDraft,  # noqa: F401
    ProductContentDraft,  # noqa: F401
    SEOElementsDraft,  # noqa: F401
)
