...
# Creative Specialist uses Gemini 2.0 Flash for multimodal reasoning (can see images)
CREATIVE_SPECIALIST_MODEL = "gemini-2.0-flash"
...
def create_creative_specialist(
    ...
    Args:
        model: Optional LLM override. Defaults to Gemini 2.0 Flash (multimodal).
    ...
    # Use provided model or default to Gemini 2.0 Flash (multimodal)
