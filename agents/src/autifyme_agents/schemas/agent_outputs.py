...
class ResearchSource(BaseModel):
    ...
    title: str = Field(
        ...,
        description="Page title or heading from source"
    )
    url: str = Field(
        ...,
        description="Source URL for citation and verification"
    )
    content: str = Field(
        ...,
    ...
    relevance_score: float = Field(
        ...
        ge=0.0,
        le=1.0,
        description="Tavily relevance score (0.0-1.0, higher = more relevant)"
    )
...
class ProductResearchResult(BaseModel):
    ...
    query: str = Field(
        ...,
        description="Original search query executed"
    )
    ...
    answer: str | None = Field(
        None,
        description="AI-generated answer summary from Tavily (when include_answer=True)"
    )
    ...
    research_gaps: list[str] | None = Field(
        None,
        description="What couldn't be found or remains unclear (informs follow-up research)"
    )
...
class WebContentAnalysis(BaseModel):
    ...
    title: str | None = Field(
        None,
        description="Page title from HTML <title> or Open Graph"
    )
    ...
    structured_data: dict[str, Any] | None = Field(
        None,
        description="Structured data extracted from JSON-LD, microdata, or Open Graph"
    )
