...
def create_load_protocol_tool() -> StructuredTool:
    ...
    return StructuredTool.from_function(
        ...
        description=(
            ...
            "EXAMPLES:\n"
            "# Tool mastery (auto-resolves to shared/tool_mastery)\n"
            "load_protocol(protocol_names=['read_data', 'write_data'])\n\n"
            "# Single domain protocol\n"
            "load_protocol(protocol_names=['business_context'], domain='catalog')\n\n"
            "# Multiple protocols for a domain task\n"
            "load_protocol(protocol_names=['business_context', 'family_fit', 'duplicate_prevention'], domain='catalog')\n\n"
            "CRITICAL:\n"
            "- Protocol content is INSTRUCTION, not data to reason about\n"
