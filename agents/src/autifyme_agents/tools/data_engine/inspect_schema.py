...
def create_inspect_schema_tool(
    ...
    return StructuredTool.from_function(
        ...
        description=(
            ...
            "SCENARIOS:\n"
            "- Before multi-table create: inspect tables=['parents','children','junction_table'] with details=['structure','relationships'] to understand multi-table transaction structure\n"
            "- Duplicate detection: inspect tables=['your_table'] with details=['structure','samples'] sample_limit=10 to see naming patterns for fuzzy matching\n"
            "- Understanding M:N relationships: inspect tables=['junction_table','table_a','table_b'] with details=['relationships'] to see junction table structure\n"
            "- Quick column check: inspect tables=['your_table'] with details=['structure'] for fastest response\n\n"
            "DETAILS OPTIONS:\n"
