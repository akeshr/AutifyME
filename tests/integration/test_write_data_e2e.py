...
class TestWriteDataAssetUploadsE2E:
    ...
    async def test_create_product_with_image(self, write_tool, storage, temp_image_file):
    ...
    async def test_create_with_multiple_images(
        ...
        products = await storage.query_entities("products", {"sku_code": "MULTI-IMG-001"})
    ...
    async def test_asset_metadata_reference(self, write_tool, storage, temp_image_file):
    ...
    async def test_asset_with_dependent_operations(self, write_tool, storage, temp_image_file):
...
class TestComplexWorkflowE2E:
    ...
    async def test_full_product_catalog_creation(self, write_tool, storage, temp_image_file):
    ...
    async def test_mixed_operations_workflow(self, write_tool, storage):
        ...
        # Verify results
        new_product = await storage.query_entities("products", {"sku_code": "MIX-NEW"})
