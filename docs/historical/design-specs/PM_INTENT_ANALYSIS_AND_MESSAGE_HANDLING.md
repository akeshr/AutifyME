...
| **LLM reasoning** (gpt-4.1-mini-2025-04-14 native intelligence) | Fast, flexible, handles nuance well | Less explicit control, harder to debug |

**Decision**: **LLM reasoning** with structured prompts.

**Rationale**:
- gpt-4.1-mini-2025-04-14 is sophisticated enough to classify intents from semantic descriptions
