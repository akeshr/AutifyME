...
| **LLM reasoning** (gpt-5-mini-2025-08-07 native intelligence) | Fast, flexible, handles nuance well | Less explicit control, harder to debug |

**Decision**: **LLM reasoning** with structured prompts.

**Rationale**:
- gpt-5-mini-2025-08-07 is sophisticated enough to classify intents from semantic descriptions
