...
| **LLM reasoning** (GPT-4o native intelligence) | Fast, flexible, handles nuance well | Less explicit control, harder to debug |

**Decision**: **LLM reasoning** with structured prompts.

**Rationale**:
- GPT-4o is sophisticated enough to classify intents from semantic descriptions
