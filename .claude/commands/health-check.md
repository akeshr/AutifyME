...
try:
    ...
    # Test vision LLM
    vision_llm = get_llm(provider='openai', model='gpt-4.1-nano-2025-04-14')
    print(f'✅ Vision LLM: {vision_llm.model_name if hasattr(vision_llm, \"model_name\") else \"gpt-4.1-nano-2025-04-14\"}')
